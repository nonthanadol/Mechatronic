...
servo5 = servo.Servo(pca.channels[6])
def printscreen():
    print('################################################')
    print('angle joint1 = {0:.2f}'.format(servo0.angle))
    print('angle joint2 = {0:.2f}'.format(servo1.angle))
    print('angle joint3 = {0:.2f}'.format(servo2.angle))
    print('angle joint4 = {0:.2f}'.format(servo3.angle))
    print('angle joint5 = {0:.2f}'.format(servo4.angle))
    print('angle joint6 = {0:.2f}'.format(servo5.angle))
    print('################################################')
